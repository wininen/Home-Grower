...
const create = context => {
  ...
  if (always) {
    ...
    node => node.type === 'ImportDeclaration', // export type Foo = ...
    // export opaque type Foo = ...
    // export type Foo from ...
    // export opaque type Foo from ...
    node => node.type === 'ExportNamedDeclaration' && node.exportKind === 'type', // type Foo = ...
    node => node.type === 'TypeAlias', // opaque type Foo = ...
